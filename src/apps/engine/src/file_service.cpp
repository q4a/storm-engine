...
std::vector<std::filesystem::path> iter_directory(DirIterator &it, std::error_code &ec, std::filesystem::path &curPath,
                                                  const char *mask, bool getPaths, bool onlyDirs, bool onlyFiles)
{
                                                                   ...
                                                                   bool recursive)
{
    ...
    if (recursive)
    {
        ...
        return iter_directory(it, ec, curPath, mask, getPaths, onlyDirs, onlyFiles);
    }
    else
    {
