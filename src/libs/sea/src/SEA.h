...
class SEA : public SEA_BASE
{
  private:
    ...
    struct SeaBlock
    {
        ...
        SeaBlock(int32_t iX1, int32_t iX2, int32_t iY1, int32_t iY2, int32_t iSize0, int32_t iTX, int32_t iTY, int32_t iSize, int32_t iLOD,
                 int32_t iIStart, int32_t iIFirst, int32_t iILast, bool bInProgress, bool bDone)
        {
            this->iX1 = iX1;
            this->iX2 = iX2;
            this->iY1 = iY1;
